...
export const NavTabsHome=()=>{
    return(
        <TabsH.Navigator>
            ...
            <TabsH.Screen name='Perfil' component={Formulario}
...
export const MiDrawer=()=>{
    return(
        ...
        drawerIcon:()=>(<FontAwesome name='home' size={30}/>)}} component={NavTabsHome}/>
            ...
            <Drawer.Screen name='Registro' options={{headerShown:false,
        drawerIcon:()=>(<FontAwesome name='home' size={30}/>)}} component={Formulario}/>
        </Drawer.Navigator>
    )
}
